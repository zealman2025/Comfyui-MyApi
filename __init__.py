...
from .partial_redraw_node import NODE_CLASS_MAPPINGS as PARTIAL_REDRAW_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as PARTIAL_REDRAW_NODE_DISPLAY_NAME_MAPPINGS
# 合并所有节点映射（按类别分组排序）
NODE_CLASS_MAPPINGS = {}
# BizyAir 系列
...
# 图像处理系列
NODE_CLASS_MAPPINGS.update(PARTIAL_REDRAW_NODE_CLASS_MAPPINGS)
...
# 图像处理系列
NODE_DISPLAY_NAME_MAPPINGS.update(PARTIAL_REDRAW_NODE_DISPLAY_NAME_MAPPINGS)
