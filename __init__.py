...
from .bizyair_seedream5_node import NODE_CLASS_MAPPINGS as SEEDREAM5_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as SEEDREAM5_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(SEEDREAM5_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(SEEDREAM5_NODE_DISPLAY_NAME_MAPPINGS)
