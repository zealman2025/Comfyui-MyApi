...
from .autodl_gpt_image2_node import NODE_CLASS_MAPPINGS as AUTODL_GPT_IMAGE2_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as AUTODL_GPT_IMAGE2_NODE_DISPLAY_NAME_MAPPINGS
from .geeknow_gpt_image2_node import NODE_CLASS_MAPPINGS as GEEKNOW_GPT_IMAGE2_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as GEEKNOW_GPT_IMAGE2_NODE_DISPLAY_NAME_MAPPINGS
from .geeknow_gemini_image_node import NODE_CLASS_MAPPINGS as GEEKNOW_GEMINI_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as GEEKNOW_GEMINI_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(AUTODL_GPT_IMAGE2_NODE_CLASS_MAPPINGS)
# Geeknow
NODE_CLASS_MAPPINGS.update(GEEKNOW_GPT_IMAGE2_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(GEEKNOW_GEMINI_NODE_CLASS_MAPPINGS)
# 文本处理系列
...
NODE_DISPLAY_NAME_MAPPINGS.update(AUTODL_GPT_IMAGE2_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(GEEKNOW_GPT_IMAGE2_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(GEEKNOW_GEMINI_NODE_DISPLAY_NAME_MAPPINGS)
# 文本处理系列
